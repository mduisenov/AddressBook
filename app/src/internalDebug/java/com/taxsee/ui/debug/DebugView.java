...
import com.taxsee.data.ApiEndpoint;
import com.taxsee.data.ApiEndpoints;
import com.taxsee.data.IsMockMode;
import com.taxsee.data.LumberYard;
import com.taxsee.data.NetworkDelay;
import com.taxsee.data.NetworkFailurePercent;
import com.taxsee.data.NetworkVariancePercent;
import com.taxsee.data.PicassoDebugging;
import com.taxsee.data.PixelGridEnabled;
import com.taxsee.data.PixelRatioEnabled;
import com.taxsee.data.ScalpelEnabled;
import com.taxsee.data.ScalpelWireframeEnabled;
import com.taxsee.data.prefs.InetSocketAddressPreferenceAdapter;
import com.taxsee.ui.logs.LogsDialog;
import com.taxsee.ui.misc.EnumAdapter;
import com.taxsee.util.Keyboards;
import com.taxsee.util.Strings;
...
public final class DebugView extends FrameLayout {
    ...
    void showLogs() {
        new LogsDialog(new ContextThemeWrapper(getContext(), R.style.Theme_AddressBookTheme), lumberYard).show();
    }
